...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    ST_ASSIGN = 258,               /* ST_ASSIGN  */
    LESS_OR_EQUAL = 259,           /* LESS_OR_EQUAL  */
    GREATER_OR_EQUAL = 260,        /* GREATER_OR_EQUAL  */
    NOT_EQUAL = 261,               /* NOT_EQUAL  */
    MODULO = 262,                  /* MODULO  */
    OBJECT_EQUALS = 263,           /* OBJECT_EQUALS  */
    OBJECT_NOT_EQUALS = 264,       /* OBJECT_NOT_EQUALS  */
    IDENTIFIER = 265,              /* IDENTIFIER  */
    STRING = 266,                  /* STRING  */
    KEYWORD = 267,                 /* KEYWORD  */
    SYMCONST = 268,                /* SYMCONST  */
    COLONVAR = 269,                /* COLONVAR  */
    CHARCONST = 270,               /* CHARCONST  */
    INTEGER = 271,                 /* INTEGER  */
    EOL = 272,                     /* EOL  */
    CLASS = 273                    /* CLASS  */
  };
